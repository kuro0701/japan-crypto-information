...
function createSiteContentService({
  ...
  const siteNavGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: '紹介特典比較', href: '/campaigns/referrals' },
        { label: 'bitFlyer紹介', href: '/campaigns/bitflyer' },
        { label: 'Coincheckキャンペーン', href: '/campaigns/coincheck' },
        { label: 'GMOコインキャンペーン', href: '/campaigns/gmo-coin' },
      ],
    },
  ];
  ...
  function renderCompareToolCards() {
    const tools = [
      ...
      {
        title: '出来高シェア',
        description: '取引の活発さ（出来高/流動性）を見る',
  ...
  function renderCompareToolSection(titleId) {
    return [
      ...
      '          <p class="text-xs text-gray-500 mt-1">注文する前に、実際の取引価格（板情報）・販売所の手数料相当額（スプレッド）・取引の活発さ（出来高/流動性）を銘柄ごとに比較・確認できます。</p>',
      '        </div>',
