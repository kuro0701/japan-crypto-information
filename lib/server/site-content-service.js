...
function createSiteContentService({
  ...
  function articleHeroTitle(article) {
    ...
    if (String(article && article.slug || '').toLowerCase() !== 'usd1') {
      return xmlEscape(title);
    }

    return [
      '<span class="article-hero__title-phrase">USD1総合分析</span>',
      '<span class="article-hero__title-group"><span aria-hidden="true">｜</span>発行体・準備金・償還</span>',
      '<span class="article-hero__title-group"><span aria-hidden="true">・</span>マルチチェーン</span>',
      '<span class="article-hero__title-group"><span aria-hidden="true">・</span>規制リスク</span>',
    ].join('');
  }
