...
function createSiteContentService({
  ...
  function renderFinancialComparisonHtml(req) {
    ...
    return injectCommonDisclosure([
      ...
      '  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>',
      '  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Noto+Sans+JP:wght@400;500;700&display=swap" rel="stylesheet">',
      '  <link rel="stylesheet" href="/css/style.css?v=ui-26">',
      '</head>',
      ...
      '          <p id="financial-shape-note" class="text-xs text-gray-500 mt-1">資産・負債・純資産、売上・費用・営業利益をボックスの大きさと内訳で比較します。</p>',
      '        </div>',
      ...
      '  <script src="/js/financial-comparison.js?v=8"></script>',
      '</body>',
      '</html>',
