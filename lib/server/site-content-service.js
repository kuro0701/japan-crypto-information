...
function createSiteContentService({
  ...
  const siteNavGroups = [
    {
      ...
      items: [
        ...
        { label: '出金手数料', href: '/learn/jpy-withdrawal-fees' },
      ],
    },
    {
      id: 'markets',
  ...
  function navSectionForPath(value) {
    ...
    if (navPath === '/learn/crypto-fees' || navPath === '/learn/jpy-withdrawal-fees') return 'comparison';
  ...
  function renderArticleHtml(req, article) {
    ...
    const feeComparisonPaths = new Set(['/learn/crypto-fees', '/learn/jpy-withdrawal-fees']);
  ...
  function renderExchangeConclusionCard(exchange) {
    ...
    return UIComponents.renderConclusionCard({
      ...
      title: `1. ${exchange.fullName || exchange.label} の結論カード`,
      titleTag: 'h2',
      badgeLabel: 'Summary',
      badgeTone: 'ready',
      lead: verdict,
  ...
  function renderExchangeCompanyCards(exchange) {
    ...
    return cards.map((card) => {
      if (!card.checks) {
        return UIComponents.renderFinancialMetricCard({
