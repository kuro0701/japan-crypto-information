    ...
    const supportedExchanges = market.exchanges.map((exchange) => {
      ...
      return {
        ...
        actions: exchangeInfo ? {
          ...
          signupUrl: exchangeInfo.pageContent && (exchangeInfo.pageContent.signupUrl || exchangeInfo.pageContent.officialUrl)
            ? (exchangeInfo.pageContent.signupUrl || exchangeInfo.pageContent.officialUrl)
            : null,
        } : {
