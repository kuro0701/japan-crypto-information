  ...
  getHistory(windowKey = '30d') {
    ...
    return {
      meta: {
        ...
        earliestVolumeDateJst: snapshots[0] ? snapshots[0].volumeDateJst || snapshots[0].jstDate || null : null,
        latestVolumeDateJst: snapshots[snapshots.length - 1]
          ? snapshots[snapshots.length - 1].volumeDateJst || snapshots[snapshots.length - 1].jstDate || null
          : null,
        recordCount: rows.length,
      },
      rows,
