...
const PAGE_CONFIGS = {
  ...
  simulator: {
    ...
    path: '/simulator',
    name: '成行注文シミュレーター',
    title: '成行注文シミュレーター｜BTC・ETH国内取引所リアルタイム板｜国内暗号資産取引所ナビ',
    description: '日本の暗号資産取引所の板情報をリアルタイムに取得し、成行注文の執行価格・スリッページ・マーケットインパクトをシミュレーション。OKJ・Coincheck・bitFlyer・bitbank・GMOコイン・Binance Japan・BitTrade対応。',
