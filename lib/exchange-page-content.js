...
const EXCHANGE_PAGE_CONTENT = Object.freeze({
  ...
  bitflyer: {
    ...
    financialAnalysis: {
      sourceSummary: '公式会社概要、決算公告、bitFlyer Holdings の公開情報で確認',
      summary: {
        disclosureStatus: '公式会社概要・決算公告・グループ公開情報で確認',
      },
      indicators: {
        parentPresence: '株式会社 bitFlyer Holdings 系として公開資料を確認',
        listedCompany: '運営会社または親会社の上場有無を公開資料で確認',
        disclosureUpdatedAt: '決算公告・公式開示資料の更新日を確認',
      },
      businessPosition: 'bitFlyer グループの暗号資産交換業、Lightning、周辺サービスの位置づけを確認',
      revenueSource: '取引手数料、販売所スプレッド、Lightning 関連収益などの公開説明を確認',
      groupDisclosure: 'bitFlyer Holdings と bitFlyer の会社概要・公告・公式発表を確認',
    },
    features: {
      spotTrading: 'あり',
      leverageTrading: '公式提供状況を確認',
  ...
  'binance-japan': {
    ...
    financialAnalysis: {
      sourceSummary: '公式会社概要、Binance グループの公式情報、金融庁・財務局の公表情報で確認',
      summary: {
        disclosureStatus: '公式会社概要・グループ公式情報で確認',
      },
      indicators: {
        parentPresence: 'Binance グループ系として公式情報を確認',
        listedCompany: '運営会社または親会社の上場有無を公開資料で確認',
        disclosureUpdatedAt: '公式会社概要・グループ公式情報の更新日を確認',
      },
      businessPosition: 'Binance グループの日本向け暗号資産交換業として、国内サービス範囲を確認',
      revenueSource: 'スポット取引手数料、日本向けサービスの収益構成を公開情報で確認',
      groupDisclosure: 'Binance Japan の会社概要、Binance グループ公式情報、金融庁・財務局の登録情報を確認',
    },
    features: {
      spotTrading: 'あり',
