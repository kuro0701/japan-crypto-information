...
description: イーサリアムの歴史、EVM、PoS、L2、供給・バーン、ステーキング、DeFi・RWA、ETF、主要チェーン比較、評価シナリオとリスクを機関投資家向けに総合分析します。
date: 2026-07-11
updated: 2026-07-17
author: 国内暗号資産取引所ナビ
slug: eth
...
実務上のリスク分析では、現物・ETF・ステーキングを異なるエクスポージャーとして区別できます。ETFは規制されたアクセス手段、直接・委任ステーキングは利回り特性を持つ手段ですが、後者にはスラッシング、アンボンディング、カストディ、税務の論点があります。価格ヘッジではCMEのEther futures/optionsのような規制市場も利用でき、ベータ保有とボラティリティ管理を分けて分析できます。モニタリング指標の候補には、総供給変化、ETH.STORE、L2 TVS/UOPS、Ethereum上のstablecoins/RWA残高、ETF純資産、MEV builder集中度が含まれます。
...
分析上、ETHは単なる「高ベータのL1トークン」だけでなく、「オンチェーン金融インフラへのエクスポージャー候補」として評価できます。評価指標には、L2 settlement、資本残高、ステーキング、制度化された投資商品の浸透度が挙げられます。短期では、アップグレード・規制・ETFフロー・MEV／セキュリティイベントによる価格変動リスクがあります。本レポートは売買方向を推奨するものではなく、利用量だけでなく価値捕捉の導線を確認することが重要という分析結果を示します。
...
- [Danksharding（Ethereum.org）](https://ethereum.org/en/roadmap/danksharding/)
...
- [Ethereumホワイトペーパー日本語版](https://ethereum.org/ja/whitepaper/)

### 市場・オンチェーンデータ

- [Ethereum Chain Overview（DefiLlama）](https://defillama.com/chain/ethereum)
- [Ethereum L2 Summary（L2Beat）](https://l2beat.com/scaling/summary)
- [Ethereum Network Explorer（Etherscan）](https://etherscan.io/)
- [ETH.STORE ステーキング参照レート（beaconcha.in）](https://beaconcha.in/ethstore)
- [ETH Supply Dashboard（ultrasound.money）](https://ultrasound.money/)
- [Ethereum Price and Market Data（CoinGecko）](https://www.coingecko.com/en/coins/ethereum)
- [Ethereum Price（Binance）](https://www.binance.com/en/price/ethereum)

### 機関投資家・企業導入・規制

- [iShares Ethereum Trust ETF（BlackRock）](https://www.blackrock.com/us/individual/products/337614/ishares-ethereum-trust-etf)
- [Ethereum Investment Thesis（Fidelity Digital Assets）](https://www.fidelitydigitalassets.com/research-and-insights/ethereum-investment-thesis)
- [Ether Futures and Options（CME Group）](https://www.cmegroup.com/markets/cryptocurrencies/ether/ether.html)
- [iShares Staked Ethereum Trust ETF 提出資料（SEC）](https://www.sec.gov/Archives/edgar/data/2099103/000143774926004276/iset20260214_s1a.htm)
- [BlackRock BUIDLローンチ（Securitize）](https://securitize.io/learn/press/blackrock-launches-first-tokenized-fund-buidl-on-the-ethereum-network)
- [BenjiオンチェーンMMF（Franklin Templeton）](https://digitalassets.franklintempleton.com/benji/)
- [PayPal USD（PayPal）](https://www.paypal.com/us/digital-wallet/manage-money/crypto/pyusd)
- [USDCによるEthereum決済（Visa）](https://corporate.visa.com/en/sites/visa-perspectives/trends-insights/digital-currency-comes-to-visas-settlement-platform.html)
- [MiCA・暗号資産規制（European Commission）](https://finance.ec.europa.eu/digital-finance/crypto-assets_en)
